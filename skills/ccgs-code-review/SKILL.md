...
description: "In a CCGS game project, architectural code review — coding standards, SOLID, testability, performance concerns."
---
...
**Argument:** `$ccgs-code-review [file(s)]` may optionally include a story file path as the last argument (e.g., `$ccgs-code-review src/combat/attack.gd production/epics/combat/story-001.md`). If a story path is provided, read it to extract the governing ADR reference.
