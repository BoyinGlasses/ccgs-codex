...
description: "In a CCGS game project, audit assets against naming conventions, file size budgets, format standards. Finds orphaned assets, missing references."
---
