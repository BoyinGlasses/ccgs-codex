...
description: "In a CCGS game project, orchestrate the combat team — game-designer, gameplay-programmer, ai-programmer, technical-artist, sound-designer, qa-tester — design through implement and validate."
---
...
> "Usage: `$ccgs-team-combat [combat feature description]` — Provide a description of the combat feature to design and implement (e.g., `melee parry system`, `ranged weapon spread`)."
...
| 5 qa-tester (test cases) | `production/qa/test-cases/[feature]-cases.md` | `$ccgs-team-qa` Phase 4 |
| 5 qa-tester (bugs) | `production/qa/bugs/BUG-[NNN]-[slug].md` | `$ccgs-team-qa` Phase 5 |
...
- Run `$ccgs-code-review` on the implemented combat code before closing stories.
- Run `$ccgs-balance-check` to validate combat formulas and tuning values.
- Run `$ccgs-team-polish` if VFX, audio, or performance polish is needed.
