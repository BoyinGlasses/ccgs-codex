...
description: "In a CCGS game project, orchestrate the live-ops team — live-ops-designer, economy-designer, analytics-engineer, community-manager, writer — for a season or live event."
---
...
> "Usage: `$ccgs-team-live-ops [season name or event description]` — Provide the name or description of the season or live event to plan."
...
final documents and ask via `Codex user-input tool` — "May I write the season plan to
...
- Run `$ccgs-design-review` on the season design document for consistency validation.
- Run `$ccgs-sprint-plan` to schedule content creation work for the season.
- Run `$ccgs-team-release` when the season content is ready to deploy.
