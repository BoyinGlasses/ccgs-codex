---
name: ccgs-soak-test
description: "In a CCGS game project, soak test protocol for extended play — what to observe and log for slow leaks, fatigue, late-appearing edge cases."
---
...
**When to run:**
- Polish phase — before `$ccgs-gate-check release`
...
5. Run `$ccgs-bug-triage sprint` after the session to integrate any S1/S2 issues

If the verdict is FAIL, run `$ccgs-smoke-check` again after fixing the issues."
