...
description: "In a CCGS game project, find balance outliers, broken progressions, degenerate strategies, economy imbalances in formulas and data. 'Check game balance'."
---
...
exist or has no entries** (it ships as an empty stub until `$ccgs-design-system`
...
After presenting the report, use `Codex user-input tool`:
