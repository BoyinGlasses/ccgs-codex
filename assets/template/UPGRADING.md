...
**New files to add:**
```
.agents/skills/ccgs-art-bible/SKILL.md
.agents/skills/ccgs-asset-spec/SKILL.md
.claude/docs/director-gates.md
```

**Existing files to overwrite (no user content):**
```
.agents/skills/ccgs-brainstorm/SKILL.md
.agents/skills/ccgs-gate-check/SKILL.md
.agents/skills/ccgs-team-level/SKILL.md
.agents/skills/ccgs-team-narrative/SKILL.md
.agents/skills/ccgs-design-system/SKILL.md
...
**New files to add:**
```
.agents/skills/ccgs-vertical-slice/SKILL.md
CONTRIBUTING.md
SECURITY.md
```
...
```
.agents/skills/ccgs-brainstorm/SKILL.md
.agents/skills/ccgs-map-systems/SKILL.md
.agents/skills/ccgs-design-system/SKILL.md
.agents/skills/ccgs-architecture-decision/SKILL.md
.agents/skills/ccgs-create-architecture/SKILL.md
.agents/skills/ccgs-create-epics/SKILL.md
.agents/skills/ccgs-create-stories/SKILL.md
.agents/skills/ccgs-sprint-plan/SKILL.md
.agents/skills/ccgs-milestone-review/SKILL.md
.agents/skills/ccgs-playtest-report/SKILL.md
.agents/skills/ccgs-prototype/SKILL.md
.agents/skills/ccgs-story-done/SKILL.md
.agents/skills/ccgs-gate-check/SKILL.md
.agents/skills/ccgs-start/SKILL.md
.agents/skills/ccgs-quick-design/SKILL.md
.agents/skills/ccgs-setup-engine/SKILL.md
README.md
...
**New files to add:**
```
.agents/skills/ccgs-consistency-check/SKILL.md
```

**Existing files to overwrite (no user content):**
```
.agents/skills/ccgs-team-combat/SKILL.md      ← no-arg guard, verdict keywords, gate improvements
.agents/skills/ccgs-team-narrative/SKILL.md   ← no-arg guard, verdict keywords, gate improvements
.agents/skills/ccgs-team-ui/SKILL.md          ← no-arg guard, verdict keywords, gate improvements
.agents/skills/ccgs-team-release/SKILL.md     ← no-arg guard, verdict keywords, NO-GO path
.agents/skills/ccgs-team-polish/SKILL.md      ← no-arg guard, verdict keywords, gate improvements
.agents/skills/ccgs-team-audio/SKILL.md       ← no-arg guard, verdict keywords, gate improvements
.agents/skills/ccgs-team-level/SKILL.md       ← no-arg guard, verdict keywords, adjacent area checks
.agents/skills/ccgs-team-live-ops/SKILL.md    ← no-arg guard, verdict keywords, ethics enforcement
.agents/skills/ccgs-team-qa/SKILL.md          ← no-arg guard, verdict keywords, gate improvements
.agents/skills/ccgs-map-systems/SKILL.md      ← verdict keywords
.agents/skills/ccgs-create-epics/SKILL.md     ← "May I write" protocol fix, verdict keywords
.agents/skills/ccgs-create-stories/SKILL.md   ← verdict keywords
...
**New files to add:**
```
.agents/skills/ccgs-ux-design/SKILL.md
.agents/skills/ccgs-ux-review/SKILL.md
.agents/skills/ccgs-help/SKILL.md
.agents/skills/ccgs-quick-design/SKILL.md
.agents/skills/ccgs-review-all-gdds/SKILL.md
.agents/skills/ccgs-story-readiness/SKILL.md
.agents/skills/ccgs-story-done/SKILL.md
.agents/skills/ccgs-sprint-status/SKILL.md
.agents/skills/ccgs-adopt/SKILL.md
.agents/skills/ccgs-create-architecture/SKILL.md
.agents/skills/ccgs-create-control-manifest/SKILL.md
.agents/skills/ccgs-create-epics/SKILL.md
.agents/skills/ccgs-create-stories/SKILL.md
.agents/skills/ccgs-dev-story/SKILL.md
.agents/skills/ccgs-propagate-design-change/SKILL.md
.agents/skills/ccgs-content-audit/SKILL.md
.agents/skills/ccgs-architecture-review/SKILL.md
.agents/skills/ccgs-qa-plan/SKILL.md
.agents/skills/ccgs-smoke-check/SKILL.md
.agents/skills/ccgs-soak-test/SKILL.md
.agents/skills/ccgs-regression-suite/SKILL.md
.agents/skills/ccgs-test-setup/SKILL.md
.agents/skills/ccgs-test-helpers/SKILL.md
.agents/skills/ccgs-test-evidence-review/SKILL.md
.agents/skills/ccgs-test-flakiness/SKILL.md
.agents/skills/ccgs-skill-test/SKILL.md
.agents/skills/ccgs-bug-triage/SKILL.md
.agents/skills/ccgs-team-live-ops/SKILL.md
.agents/skills/ccgs-team-qa/SKILL.md
...
.agents/skills/ccgs-sprint-plan/SKILL.md
.agents/skills/ccgs-sprint-status/SKILL.md
.agents/skills/ccgs-design-review/SKILL.md
.agents/skills/ccgs-team-ui/SKILL.md
.agents/skills/ccgs-story-readiness/SKILL.md
.agents/skills/ccgs-story-done/SKILL.md
...
**Existing files to overwrite (no user content):**
```
.agents/skills/ccgs-map-systems/SKILL.md      ← was design-systems/SKILL.md
.agents/skills/ccgs-gate-check/SKILL.md
.agents/skills/ccgs-brainstorm/SKILL.md
.agents/skills/ccgs-start/SKILL.md
.agents/skills/ccgs-design-review/SKILL.md
.agents/skills/ccgs-project-stage-detect/SKILL.md
.agents/skills/ccgs-setup-engine/SKILL.md
...
```
.agents/skills/ccgs-design-systems/   ← entire directory; replaced by map-systems/
```
...
1. **Delete the old skill directory:**
   ```bash
   rm -rf .agents/skills/ccgs-design-systems/
   ```
...
.agents/skills/ccgs-project-stage-detect/SKILL.md
.agents/skills/ccgs-setup-engine/SKILL.md
.agents/skills/ccgs-team-audio/SKILL.md
.agents/skills/ccgs-team-combat/SKILL.md
.agents/skills/ccgs-team-level/SKILL.md
.agents/skills/ccgs-team-narrative/SKILL.md
.agents/skills/ccgs-team-polish/SKILL.md
.agents/skills/ccgs-team-release/SKILL.md
.agents/skills/ccgs-team-ui/SKILL.md
.claude/hooks/log-agent.sh
