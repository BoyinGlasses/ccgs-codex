...
description: "In a CCGS game project, player-facing patch notes from git history and changelogs. Translates developer language into player communication."
---
...
- Read the internal changelog at `production/releases/[version]$ccgs-changelog.md` if it exists
...
**If no changelog data is available** (neither `production/releases/[version]$ccgs-changelog.md`
...
if needed. Also write to `production/releases/[version]$ccgs-patch-notes.md` as the
