...
description: "In a CCGS game project, pre-release checklist — build verification, certification requirements, store metadata, launch readiness."
---
...
>
> `$ccgs-launch-checklist` scans the same way and is most often run beside this one.
...
> running `$ccgs-release-checklist` with no argument would be handed the Steamworks SDK
