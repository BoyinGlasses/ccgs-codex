...
> existing contract (e.g. `.agents/skills/ccgs-dev-story/CONTRACT.md`) rather than
> this template's schema-heavy form until the two are reconciled.

**Purpose:** Define formal handoff contract for a skill. Create as `.agents/skills/<skill-name>/CONTRACT.md`.
...
**Version:** 1.0
**Last Updated:** [DATE]
**Skill File:** `.agents/skills/[SKILL_NAME]/SKILL.md`
**Test File:** `.agents/skills/[SKILL_NAME]/TESTS.md`
