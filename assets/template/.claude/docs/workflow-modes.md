...
> `.agents/skills/ccgs-gate-check/SKILL.md` §"Per-system overrides"), and it runs at a
...
tier reductions live in `.agents/skills/ccgs-gate-check/references/gate-<phase>.md`,
