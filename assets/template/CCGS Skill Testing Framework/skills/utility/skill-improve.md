...
**Fixture:**
- `.agents/skills/ccgs-some-skill/SKILL.md` has 2 static failures:
...
4. Skill asks "May I write improvements to `.agents/skills/ccgs-some-skill/SKILL.md`?"
...
**Fixture:**
- `.agents/skills/ccgs-some-skill/SKILL.md` has 1 static failure (missing handoff)
...
**Fixture:**
- `.agents/skills/ccgs-gate-check/SKILL.md` is a gate skill with 1 static failure
...
4. "May I write improvements to `.agents/skills/ccgs-gate-check/SKILL.md`?"
...
**Fixture:**
- `.agents/skills/ccgs-brainstorm/SKILL.md` has no static failures
